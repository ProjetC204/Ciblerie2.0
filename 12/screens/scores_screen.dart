                            ...
                            return Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    _buildScoreCard(
                                      '${ws.pseudonymsNotifier.value[0] ?? "J1"} : ${scores[0] ?? 0}',
                                      cardWidth,
                                      cardHeight,
                                      fontSize,
                                    ...
                                    _buildScoreCard(
                                      '${ws.pseudonymsNotifier.value[1] ?? "J2"} : ${scores[1] ?? 0}',
                                      cardWidth,
                                      cardHeight,
                                      fontSize,
                                      const LinearGradient(
                                ...
                                Row(
                                  ...
                                  children: [
                                    _buildScoreCard(
                                      '${ws.pseudonymsNotifier.value[2] ?? "J3"} : ${scores[2] ?? 0}',
                                      cardWidth,
                                      cardHeight,
                                      fontSize,
                                      const LinearGradient(
                                    ...
                                    SizedBox(width: spacing),
                                    _buildScoreCard(
                                      '${ws.pseudonymsNotifier.value[3] ?? "J4"} : ${scores[3] ?? 0}',
                                      cardWidth,
                                      cardHeight,
                                      fontSize,
                                      const LinearGradient(
