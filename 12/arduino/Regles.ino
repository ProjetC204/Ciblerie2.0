...
void EcranEnJeu() {
    ...
    // Affichage des scores sur le grand écran
    ...
    // Ajout d'un zéro si le score est inférieur à 10
    if (length == 1) {
        printBigNum(0, 14, 1); // Position pour le zéro
    }
}
